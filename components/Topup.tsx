...
const API_BASE_URL = "https://almudatasub.com.ng/app/api/fund-wallet/index.php";
...
export default function FundAccountPage() {
  ...
  const handleGenerateAccount = async () => {
    ...
    try {
      const response = await fetch(
        `https://almudatasub.com.ng/app/debug.php?token=${encodeURIComponent(
          token
        )}`,
        {
          method: "POST",
  ...
  const submitManualVerification = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://almudatasub.com.ng/app/api/fund-wallet/manual/index.php",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
